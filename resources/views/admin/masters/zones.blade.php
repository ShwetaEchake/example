                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" name="name" type="text" placeholder="Enter Zone Name">
                            ...
                            <section class="card">
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-4">
                                            <label class="col-form-label" for="name">Zone Name <span class="text-danger">*</span></label>
                                            <input class="form-control" name="name" type="text" placeholder="Zone Name">
...
<!-- Delete -->
<script>
    $("#advance-1").on("click", ".rem-element", function(e) {
        e.preventDefault();
        swal({
